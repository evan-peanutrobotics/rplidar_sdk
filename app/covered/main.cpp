...
//    while (0) {
        ...
        if (SL_IS_OK(op_result)) {
            ...
            for (int pos = 0; pos < (int)count ; ++pos) {
                float ang = nodes[pos].angle_z_q14 * 90.f / 16384.f;
                if (ang > 350 || ang < 10){
                    val_count ++;
                    sum += nodes[pos].dist_mm_q2/4.0f;
                } 
            /*
            ...
            printf("Number of scans in range: %d\n", val_count);
            sum = sum / val_count;
